package org.example.spring.lesson2.controller;

import org.example.spring.lesson2.domain.Product;
import org.example.spring.lesson2.service.ProductServiceImpl;
...
public class ProductController {
    ...
    // http://localhost:8080/app/products/filter {title:"asd"}
    @PostMapping("/filter")
    @ResponseBody
