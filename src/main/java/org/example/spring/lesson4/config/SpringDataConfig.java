package org.example.spring.lesson4.config;
...
@Configuration
@EnableJpaRepositories("org.example.spring.lesson4.repository")
@EnableTransactionManagement
@ComponentScan("org.example.spring.lesson4")
public class SpringDataConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean getEntityManager() {
        ...
        factory.setPackagesToScan("org.example.spring.lesson4.domain");
